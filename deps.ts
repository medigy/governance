...
export * as governedInstr from "https://denopkg.com/gov-suite/governed-instrument@v0.7.6/core/mod.ts";
...
export * as inspect from "https://denopkg.com/shah/ts-inspect@v0.6.7/mod.ts";
export * as inspText from "https://denopkg.com/shah/ts-inspect@v0.6.7/text/mod.ts";
export * as nihLhcForms from "https://denopkg.com/shah/ts-lhncbc-lforms@v1.5.12/mod.ts";
