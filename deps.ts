...
export * as fs from "https://deno.land/std@v0.70.0/fs/mod.ts";
export * as path from "https://deno.land/std@v0.70.0/path/mod.ts";
export * as governedInstr from "https://denopkg.com/gov-suite/governed-instrument@v0.7.0/core/mod.ts";
export * as govnDataCLI from "https://denopkg.com/gov-suite/governed-structured-data@v0.5.13/cli.ts";
export * as govnData from "https://denopkg.com/gov-suite/governed-structured-data@v0.5.13/mod.ts";
...
export * as nihLhcForms from "https://denopkg.com/shah/ts-lhncbc-lforms@v1.3.7/mod.ts";
