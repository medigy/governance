...
export * as fs from "https://deno.land/std@v0.74.0/fs/mod.ts";
export * as path from "https://deno.land/std@v0.74.0/path/mod.ts";
export * as docopt from "https://denopkg.com/Eyal-Shalev/docopt.js@v1.0.1/src/docopt.ts";
export * as governedInstr from "https://denopkg.com/gov-suite/governed-instrument@v0.7.5/core/mod.ts";
export * as govnDataCLI from "https://denopkg.com/gov-suite/governed-structured-data@v0.7.0/cli.ts";
export * as govnData from "https://denopkg.com/gov-suite/governed-structured-data@v0.7.0/mod.ts";
...
export * as inspect from "https://denopkg.com/shah/ts-inspect@v0.6.6/mod.ts";
export * as inspText from "https://denopkg.com/shah/ts-inspect@v0.6.6/text/mod.ts";
export * as nihLhcForms from "https://denopkg.com/shah/ts-lhncbc-lforms@v1.5.11/mod.ts";
